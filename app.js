...
.select("*, casos(id_inspec,hoja_de_ruta,nombre_predio), sol(nombre_completo), apr(nombre_completo)")
...
MODAL.abrir(      <h3>Solicitar Modificación</h3>
...
cont.innerHTML =       <div class="mb-4 pb-2 border-b border-slate-100 flex items-center justify-between">
      ...
      <div>
        ${pendientes.map(p => {
          const iconHtml = p.ok 
            ?<span class="material-symbols-outlined text-[16px] text-emerald-600 shrink-0">check_circle</span>            :<span class="material-symbols-outlined text-[16px] text-amber-600 shrink-0">pending</span>;
          return 
...
cont.innerHTML =       <div class="flex items-center justify-between pb-3 border-b border-slate-100 mb-3">
...
UTIL.qs("#tabla-usuarios-body").innerHTML = data.map(p =>       <tr>
